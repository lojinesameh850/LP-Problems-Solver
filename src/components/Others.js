...
function OthersForm() {
  ...
  return(
    ...
    {askForMethod && (
      <>
        <Select defaultValue="bigM" onChange={(e) => {setMethod(e.target.value)}} sx={{ width: "200px", height: "35px" }}>
            <MenuItem value="bigM">Big M Method</MenuItem>
            <MenuItem value="twoPhase">Two Phase Method</MenuItem>
          </Select>
      </>
    )}
      {matrix.length > 0 && (
