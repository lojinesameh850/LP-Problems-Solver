  ...
  return(
    <div style={{ backgroundColor: "#3A404C", height: "100%", width: "100%", color: "#ffffff", padding: "15px", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
        ...
        {askForMethod && (
          <>
            <Select defaultValue="bigM" onChange={(e) => {setMethod(e.target.value)}} sx={{ width: "200px", height: "35px", marginTop: "15px" }}>
                <Option value="bigM">Big M Method</Option>
                <Option value="twoPhase">Two Phase Method</Option>
              </Select>
          </>
        )}
